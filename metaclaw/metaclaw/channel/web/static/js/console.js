/* =====================================================================
   Web Console - Main Application Script
   ===================================================================== */
...
function _openImageLightbox(src) {
    let overlay = document.getElementById('metaclaw-lightbox');
    if (!overlay) {
        overlay = document.createElement('div');
        overlay.id = 'metaclaw-lightbox';
    ...
    overlay.querySelector('#metaclaw-lightbox-img').src = src;
...
const WECOM_BOT_SOURCE = 'metaclaw';
