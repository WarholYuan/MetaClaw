...
def _aes_ecb_encrypt(data: bytes, key: bytes) -> bytes:
    from Crypto.Cipher import AES  # nosec B413: Required for WeChat AES-128-ECB message encryption
...
def _aes_ecb_decrypt(data: bytes, key: bytes) -> bytes:
    from Crypto.Cipher import AES  # nosec B413: Required for WeChat AES-128-ECB message decryption
    cipher = AES.new(key, AES.MODE_ECB)
