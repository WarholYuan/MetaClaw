---
title: v2.0.7
description: MetaClaw 2.0.7 - Image Generation Skill (6-provider auto-routing), new models, knowledge base enhancements, Web Console improvements and bug fixes
---
...
Docs: [Image Generation Skill](https://docs.metaclaw.ai/en/skills/image-generation)
...
**Release Date**: 2026.04.22 | [Full Changelog](https://github.com/WarholYuan/MetaClaw/compare/2.0.6...master)
