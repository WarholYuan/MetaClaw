...
The repository has been officially renamed to **MetaClaw**, evolving into a full-featured AI Agent assistant.

- New URL: [github.com/WarholYuan/MetaClaw](https://github.com/WarholYuan/MetaClaw) — GitHub auto-redirects the old URL
...
**Release Date**: 2026.04.14 | [Full Changelog](https://github.com/WarholYuan/MetaClaw/compare/2.0.5...master)
