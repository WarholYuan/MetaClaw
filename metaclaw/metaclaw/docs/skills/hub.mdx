...
[Cow Skill Hub](https://skills.metaclaw.ai/) 是开源的 AI Agent 技能广场，汇集了官方推荐、社区贡献和第三方平台（GitHub、ClawHub 等）的技能。

开源仓库：[github.com/WarholYuan/MetaClaw-skill-hub](https://github.com/WarholYuan/MetaClaw-skill-hub)
...
1. 访问 [skills.metaclaw.ai/submit](https://skills.metaclaw.ai/submit)
