...
项目仓库正式更名为 **MetaClaw**，演进为功能完备的 AI Agent 助理。

- 新地址：[github.com/WarholYuan/MetaClaw](https://github.com/WarholYuan/MetaClaw)，旧地址 GitHub 会自动重定向
...
**发布日期**：2026.04.14 | [Full Changelog](https://github.com/WarholYuan/MetaClaw/compare/2.0.5...master)
