...
class TaskStore:
    ...
    def __init__(self, store_path: str = None):
        ...
        Args:
            store_path: Path to tasks.json file. Defaults to ~/metaclaw/scheduler/tasks.json
        """
        if store_path is None:
            # Default to ~/metaclaw/scheduler/tasks.json
            workspace = expand_path(DEFAULT_AGENT_WORKSPACE)
