...
from common.brand import DEFAULT_ENV_FILE
...
class Read(BaseTool):
    ...
    def execute(self, args: Dict[str, Any]) -> ToolResult:
        ...
        env_config_path = expand_path(DEFAULT_ENV_FILE)
    ...
    def _resolve_path(self, path: str) -> str:
        ...
        # A path starting with .. after normalization is trying to escape
        if path.startswith('..'):
    ...
    def _is_path_allowed(self, absolute_path: str) -> tuple[bool, str]:
        ...
        # Add temp directory for bash tool outputs
        import tempfile
        allowed_bases.append(tempfile.gettempdir())
        ...
        # Special case: system temp directory subpaths
        if normalized.startswith(tempfile.gettempdir()):
            return True, ""
