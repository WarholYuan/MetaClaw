...
![Kimi API 文档首页](images/kimi-api-zero-guide/01-docs-home.png)
...
![Kimi 控制台登录入口](images/kimi-api-zero-guide/02-console-login.png)

【图 3：登录后控制台首页与实名认证入口，需登录账号后替换】

![登录后控制台首页与实名认证入口占位](images/kimi-api-zero-guide/09-console-inner-placeholder.png)
...
![Kimi API 充值协议](images/kimi-api-zero-guide/04-payment-agreement.png)

【图 5：充值、余额、消耗、发票后台页，需登录账号后替换】

![充值余额消耗发票后台占位](images/kimi-api-zero-guide/10-billing-inner-placeholder.png)
...
![API Key 管理入口](images/kimi-api-zero-guide/03-api-keys-login.png)
...
![Kimi API 余额与消耗帮助](images/kimi-api-zero-guide/06-balance-usage-help.png)

【图 8：Kimi API 价格常见问题】

![Kimi API 价格常见问题](images/kimi-api-zero-guide/05-pricing-faq.png)
...
![MetaClaw 环境变量配置](images/kimi-api-zero-guide/07-metaclaw-env.png)
...
![MetaClaw config.json 配置](images/kimi-api-zero-guide/08-metaclaw-config-json.png)
